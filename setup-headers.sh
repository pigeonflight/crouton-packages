...
echo "deb https://pigeonflight.github.io/crouton-packages/$BRANCH/ $KERNEL main" > /etc/apt/sources.list.d/crouton-packages.list
apt-get update
...
wget -O /etc/rc.local "https://pigeonflight.github.io/crouton-packages/$BRANCH/rc.local"
